...
__conda_setup="$('/home/civbag/.local/mambaforge/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/civbag/.local/mambaforge/etc/profile.d/conda.sh" ]; then
        . "/home/civbag/.local/mambaforge/etc/profile.d/conda.sh"
    else
        export PATH="/home/civbag/.local/mambaforge/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/home/civbag/.local/mambaforge/etc/profile.d/mamba.sh" ]; then
    . "/home/civbag/.local/mambaforge/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
